...
\newcommand{\pagefooterlocalization}[1]{\gdef\pagefooterlocalization{#1}} %define a command to 
\pagefooterlocalization{Seite } % can be anything, e.g. "Slide" "Page" "Seite"
\newcommand{\supervisor}[1]{\gdef\supervisor{#1}} % define a new command for supervisor in the footer of every page
...
\supervisor{Prof. Stefan Herzig} %leave empty if not applicable, do not comment out / delete
